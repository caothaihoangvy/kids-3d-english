(function() {
  ...
  function displayVehicleRound(q) {
    ...
    const buttons = elements.cardContent.querySelectorAll('.choice-btn');
    buttons.forEach(btn => {
  ...
  function handleChoice(button, correctAnswer, speechText, revealName) {
    ...
    const allButtons = elements.cardContent.querySelectorAll('.choice-btn');
    ...
    if (isCorrect) {
      ...
      if (revealName) {
        const nameEl = elements.cardContent.querySelector('.item-name');
